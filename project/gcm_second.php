...
//    echo $data[0];
   ...
   // $regid = "APA91bG9rj4pvEAUvUcFy8N19DFRgA2oRKJ3cQPHMEmQIgCKtkpxqYHhtiK4W21ZbdjXWTcV5ioZjfpX3kXz_0-coUbz2qeXBZhjCvPmLBX5Pa5NY-q8wrJ0Cl0tW-1EeImR8aO3Mh5ZHdyLzM4n5GGiScDuIuRnZQ";
    ...
    $arr = array();
    $arr['data'] = array();
    $arr['data']['title'] = $_POST[title];
    $arr['data']['content'] = $_POST[content];
    $arr['data']['data'] = $_POST[data];
    $arr['registration_ids'] = array();

    $helloidx = 0;
    $result1 = "SELECT regid FROM userinfo";
    $result = $mysqli->query($result1);
    while($row = mysqli_fetch_object($result)) 
    {                
        $arr['registration_ids'][$helloidx++] = $row->regid;
    }
